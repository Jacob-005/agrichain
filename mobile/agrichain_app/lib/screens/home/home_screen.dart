...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Future<void> _loadScore() async {
    ...
    if (result.success && result.data != null) {
      setState(() {
        _scoreData = HarvestScoreModel.fromJson(result.data!);
        _loading = false;
      });
    } else {
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            color: isSelected ? Colors.white : AgriChainTheme.darkText,
                          ),
                        ),
                      ],
                    ),
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style: const TextStyle(
                      fontSize: 15, color: AgriChainTheme.greyText),
                ),
              ),
            ),
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: const Text('I Harvested',
                        style: TextStyle(fontSize: 15)),
                    style: OutlinedButton.styleFrom(
                      foregroundColor: AgriChainTheme.primaryGreen,
                      side: const BorderSide(
                          color: AgriChainTheme.primaryGreen, width: 1.5),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            label,
            style: const TextStyle(fontSize: 11, color: AgriChainTheme.greyText),
          ),
        ],
      ),
    );
